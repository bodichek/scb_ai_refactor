...
import type { GrowthRow } from './RevenueVsCOGS'
...
/**
 * React verze šablony dashboard/index.html (sekce "Růst tržeb vs. růst provozních nákladů").
 */
export default function RevenueVsOverheads({ data, years }: Props) {
      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={filtered} margin={{ top: 12, right: 20, bottom: 0, left: 0 }}>
            ...
            <Line
              type="monotone"
              dataKey="overheads_yoy"
              name="Provozní náklady YoY %"
              stroke="#fb923c"
              strokeWidth={2}
              dot={false}
            />
